const I18N = {
  zh: {
    ...
    tipStream: "针对大文件（>800MB），插件会自动弹出两次保存窗口（视频/音频），请点击保存并保持当前页面开启，直至下载完成。",
  ...
  en: {
    ...
    tipStream: "For large files (>800MB), two save dialogs will appear (video/audio). Click save and keep the page open until download completes.",
