const I18N = {
  zh: {
    ...
    tipStream: "针对超大文件，插件会自动弹出两次保存窗口（视频/音频），请点击保存并保持当前页面开启，直至下载完成。",
    ...
    footerEmail: "反馈邮箱：",
    footerFeedback: "📮 有问题请邮箱反馈，满意请给五星好评 🌟",
  ...
  en: {
    ...
    tipStream: "For extra-large files, two save dialogs will appear (video/audio). Click save and keep the page open until download completes.",
    ...
    footerFeedback: "📮 Issues? Email us. Happy? Rate 5 stars 🌟",
